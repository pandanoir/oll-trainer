...
export declare class Radar extends PureComponent<Props, State> {
  ...
  static getComposedData: ({
    ...
    radiusAxis: React.AriaAttributes &
      import('../util/types').DOMAttributesAdaptChildEvent<any, SVGElement> &
      Omit<
        React.SVGProps<SVGElement>,
        keyof import('../util/types').DOMAttributesAdaptChildEvent<any, any>
      > &
      import('./PolarRadiusAxis').PolarRadiusAxisProps & {
        scale: (value: any) => number;
      };
    angleAxis: React.AriaAttributes &
      import('../util/types').DOMAttributesAdaptChildEvent<
        any,
        SVGTextElement
      > &
      Omit<
        ...
        keyof import('../util/types').DOMAttributesAdaptChildEvent<any, any>
      > &
      import('./PolarAngleAxis').PolarAngleAxisProps & {
        scale: (value: any) => number;
      };
    displayedData: any[];
